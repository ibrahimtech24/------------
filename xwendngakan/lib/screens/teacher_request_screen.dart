...
class _TeacherRequestScreenState extends State<TeacherRequestScreen> {
  ...
  Future<void> _fetchStatus() async {
    final statusData = await ApiService.getTeacherRequestStatus();
    if (!mounted) return;
  ...
  Future<void> _submit() async {
    ...
    final res = await ApiService.submitTeacherRequest(
  ...
  Widget build(BuildContext context) {
    ...
    if (_status == 'rejected') {
      return Scaffold(
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
        appBar: AppBar(
          title: const Text('داواکاری مامۆستا'),
          centerTitle: true,
          elevation: 0,
        ),
        body: Center(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    setState(() => _isLoading = true);
                    await ApiService.clearTeacherRequest();
                    if (!mounted) return;
                    setState(() {
                      _isLoading = false;
                      _status = null;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  'تکایە چاوەڕێ بکە تاوەکو بەڕێوەبەر ڕەزامەندی دەدات. دوای ڕەزامەندی ڕاستەوخۆ دەتوانیت فۆڕمی مامۆستا پڕ بکەیتەوە.',
                  style: TextStyle(
                    fontSize: 16,
                    height: 1.5,
                    color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'پێش ئەوەی فۆڕمی مامۆستا پڕ بکەیتەوە، پێویستە داواکارییەک بنێریت بۆ ئەوەی ڕێگەت پێ بدرێت لەلایەن بەڕێوەبەرەوە.',
                  style: TextStyle(
                    fontSize: 14,
                    height: 1.5,
                    color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.6),
